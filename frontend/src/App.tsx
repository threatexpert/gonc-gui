...
const text = {
  zh: {
    ...
    vpnDnsServers: 'DNS',
    vpnDnsServersPlaceholder: '每行一个 DNS 服务器，第一个作为主 DNS；留空会使用 Google DNS。',
    routeCidrs: '路由 CIDR',
  ...
  en: {
    ...
    vpnDnsServers: 'DNS',
    vpnDnsServersPlaceholder: 'One DNS server per line. The first is the primary DNS. Leave blank to use Google DNS.',
